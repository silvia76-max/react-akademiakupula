...
from backend.models import db, User, Course, Wishlist, Cart
...
@user_courses.route('/wishlist/<course_id>', methods=['DELETE'])
@jwt_required()
...
@user_courses.route('/cart/<course_id>', methods=['DELETE'])
@jwt_required()
